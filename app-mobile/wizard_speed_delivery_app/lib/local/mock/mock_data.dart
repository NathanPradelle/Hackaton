...
class MockData {
  ...
  static final ModeleCamion modeleMAN = ModeleCamion(
    id: 1,
    marque: 'MAN',
    nomModele: 'TGX 18.510',
    capacite: 480,
    consommationEssence: 28.5,
    typeEssence: TypeEssence.diesel,
  ...
  static final List<Commande> commandes = [
    Commande(
      ...
      clientId: 1,
      tourneeId: 1,
      adresseTexte: '12 Rue de Rivoli, 75001 Paris',
      latitude: 48.8606,
      longitude: 2.3376,
      dateVoulu: DateTime.now(),
    ...
    Commande(
      ...
      clientId: 2,
      tourneeId: 1,
      adresseTexte: '45 Av. des Champs-Élysées, 75008 Paris',
      latitude: 48.8698,
      longitude: 2.3075,
      dateVoulu: DateTime.now(),
      plageHoraire: PlageHoraire.matin,
    ...
    Commande(
      ...
      clientId: 3,
      tourneeId: 1,
      adresseTexte: '8 Place de la Bastille, 75011 Paris',
      latitude: 48.8533,
      longitude: 2.3692,
      dateVoulu: DateTime.now(),
      plageHoraire: PlageHoraire.matin,
    ...
    Commande(
      ...
      clientId: 1,
      tourneeId: 2,
      adresseTexte: '1 Place du Trocadéro, 75016 Paris',
      latitude: 48.8624,
      longitude: 2.2885,
      dateVoulu: DateTime.now().add(const Duration(days: 1)),
      plageHoraire: PlageHoraire.apresMidi,
      prix: 95.00,
      quantite: 32,
      statut: StatutCommande.enAttente,
    ),
    Commande(
      ...
      clientId: 4,
      tourneeId: 2,
      adresseTexte: '20 Rue de la Paix, 75002 Paris',
      latitude: 48.8688,
      longitude: 2.3307,
      dateVoulu: DateTime.now().add(const Duration(days: 1)),
      plageHoraire: PlageHoraire.apresMidi,
  ...
  static List<Tournee> get tournees => [
    Tournee(
      ...
      itineraire: const Itineraire(
        tourneeId: 1,
        duree: 145,
        contrainte: 'Hauteur max 4.0m, poids max 19T',
      ),
    ),
    Tournee(
      id: 2,
    ...
    Tournee(
      ...
      commandes: [
        Commande(
          ...
          clientId: 1,
          tourneeId: 3,
          adresseTexte: '55 Bd Haussmann, 75009 Paris',
          latitude: 48.8738,
          longitude: 2.3321,
          dateVoulu: DateTime.now().subtract(const Duration(days: 1)),
          plageHoraire: PlageHoraire.matin,
          prix: 110.00,
          quantite: 40,
        ...
        Commande(
          ...
          clientId: 2,
          tourneeId: 3,
          adresseTexte: '10 Rue du Fg Saint-Honoré, 75008 Paris',
          latitude: 48.8704,
          longitude: 2.3178,
          dateVoulu: DateTime.now().subtract(const Duration(days: 1)),
          plageHoraire: PlageHoraire.matin,
    ...
    Tournee(
      ...
      plageHoraire: PlageHoraire.journee,
      statut: StatutTournee.terminee,
      commandes: [
        Commande(
          id: 20,
          clientId: 3,
          tourneeId: 4,
          adresseTexte: '2 Place de la Nation, 75012 Paris',
          latitude: 48.8487,
          longitude: 2.3963,
          dateVoulu: DateTime.now().subtract(const Duration(days: 3)),
          plageHoraire: PlageHoraire.journee,
          prix: 200.00,
          quantite: 80,
          statut: StatutCommande.livree,
